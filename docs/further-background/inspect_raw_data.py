...
# ### AGAGE / GAGE
#
# The Advanced Global Atmospheric Gases Experiment (AGAGE: 1993 - present) and
# its predecessors (Atmospheric Lifetime Experiment, ALE: 1978 - 1981; Global
# Atmospheric Gases Experiment, GAGE: 1982 - 1992) have measured the greenhouse gas
# and ozone-depleting gas composition of the global atmosphere continuously since 1978.
#
# + The ALE program was instigated to measure the then five major ozone-depleting gases
# (CFC-11 (CFCl3), CFC-12 (CCl2F2), CCl4, CH3CCl3, N2O) in the atmosphere four times per
# day using automated gas chromatographs with electron-capture detectors (GC-ECDs) at
# four stations around the globe and to determine the atmospheric lifetimes of the
# purely anthropogenic of these gases from their measurements and industry data on their
# emissions (Prinn et al., 1983a).
#
# + The GAGE project broadened the global coverage to five stations, the number of gases
# being measured to eight (adding CFC-113 (CCl2FCClF2), CHCl3, and CH4 to the ALE list),
# and the frequency to 12 per day by improving the GC-ECDs and adding gas chromatographs
# with flame-ionization detectors (GC-FIDs; Prinn et al., 2000).
#
...
# gas chromatographs with mercuric oxide reduction detectors, to measure 10 biogenic
# and/or anthropogenic gases overall (adding H2 and CO to the GAGE list).
#
# ### AGAGE (5 stations):
...
# %% [markdown]
# ### NOAA - flask
# + thereof 21 ship and 274 surface measurements
