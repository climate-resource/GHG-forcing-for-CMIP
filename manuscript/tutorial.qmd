...
::: {.callout-note}
+ This document lives in the following GitHub repo: https://github.com/climate-resource/GHG-forcing-for-CMIP
+ Prerequisit: This analysis document expect the CO2 and CH4  EO and GB data to live in the directory `data/downloads/`. If they do not yet exist, run the data pipelines as described in the README of the repo ("Download the GB/EO data").
